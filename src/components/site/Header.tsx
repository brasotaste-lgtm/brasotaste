        ...
        <nav className="hidden items-center gap-8 lg:flex">
          {NAV.map((n) => (
            <a
              key={n.href}
              href={n.href}
              className={`text-[16px] font-semibold tracking-[0.20em] uppercase transition-colors ${
                scrolled
      ...
      >
        ...
        >
          ...
          <a
            href="#contato"
            onClick={() => setOpen(false)}
            className="mt-auto inline-flex w-full items-center justify-center rounded-sm bg-brand-gold py-4 text-[14px] font-semibold tracking-[0.22em] uppercase text-brand-navy"
          >
            Solicitar orçamento
          </a>
          <a
